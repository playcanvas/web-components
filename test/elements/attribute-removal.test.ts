...
describe('attribute removal', () => {
    ...
    const cases: [tag: string, attribute: string, property: string, restored: string][] = [
        ...
        ['pc-particle-system', 'asset', 'asset', ''],
        ['pc-render', 'material', 'material', ''],
        ['pc-scrollbar', 'handle', 'handle', ''],
        ['pc-scroll-view', 'viewport', 'viewport', ''],
        ['pc-scroll-view', 'content', 'content', ''],
        ['pc-scroll-view', 'horizontal-scrollbar', 'horizontalScrollbar', ''],
        ['pc-scroll-view', 'vertical-scrollbar', 'verticalScrollbar', ''],
        ['pc-sound-slot', 'asset', 'asset', ''],
        ['pc-sound-slot', 'name', 'name', ''],
